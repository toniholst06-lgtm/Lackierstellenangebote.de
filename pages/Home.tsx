...
export const Home: React.FC<HomeProps> = ({ onNavigate }) => {
  return (
    <div className="relative bg-deep-black text-gray-300 font-sans w-full">
      ...
      <div className="relative h-[85vh] w-full overflow-hidden bg-gray-900">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
          <div className="max-w-3xl animate-in fade-in slide-in-from-bottom-8 duration-700">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-accent-primary/20 border border-accent-primary rounded-full text-accent-primary text-xs font-bold uppercase tracking-widest mb-6 backdrop-blur-md">
               <Star size={12} fill="currentColor" /> Die Nr. 1 für Lackierer
            </div>
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-display font-black text-white mb-6 uppercase leading-none tracking-tight shadow-black drop-shadow-lg">
              Präzision <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent-primary to-red-600">trifft Leidenschaft</span>
            </h1>
            <p className="mt-4 text-xl md:text-2xl text-gray-200 font-light max-w-2xl leading-relaxed drop-shadow-md">
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4">
              ...
              <button
                ...
                className="px-8 py-4 bg-white/5 border-2 border-white/80 backdrop-blur-sm text-white font-display font-bold text-lg uppercase tracking-wider hover:bg-white hover:text-black transition-all rounded-md"
              >
                Stelle schalten
              </button>
            </div>
      ...
      {/* Intro Stats Section */}
      <div className="bg-gray-highlight border-y border-gray-800 relative z-20">
        <div className="max-w-7xl mx-auto px-4 py-12">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-gray-800/50">
                <div>
                    ...
                    <span className="text-xs text-gray-400 uppercase font-bold tracking-widest">Offene Stellen</span>
                </div>
                <div>
                    <span className="block text-4xl font-display font-black text-white mb-1">1.2k</span>
                    <span className="text-xs text-gray-400 uppercase font-bold tracking-widest">Lackierereien</span>
                </div>
                <div>
                    <span className="block text-4xl font-display font-black text-white mb-1">Top</span>
                    <span className="text-xs text-gray-400 uppercase font-bold tracking-widest">Gehälter</span>
                </div>
                <div>
                    <span className="block text-4xl font-display font-black text-white mb-1">24h</span>
                    <span className="text-xs text-gray-400 uppercase font-bold tracking-widest">Express Bewerbung</span>
                </div>
            </div>
        </div>
      </div>
      ...
      <div className="py-24 bg-deep-black">
         ...
         <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 h-auto md:h-[500px] w-full">
            ...
            <div className="relative group overflow-hidden h-[300px] md:h-full cursor-pointer border-r border-gray-900">
            <img src="https://images.unsplash.com/photo-1601362840469-51e4d8d58785?q=80&w=2000&auto=format&fit=crop" alt="Fahrzeugaufbereitung Polieren" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-70 group-hover:opacity-100" />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-90 flex items-end p-8">
                <div>
            ...
            <div className="relative group overflow-hidden h-[300px] md:h-full cursor-pointer border-r border-gray-900">
            <img src="https://images.unsplash.com/photo-1494976388531-d1058494cdd8?q=80&w=2000&auto=format&fit=crop" alt="Fertig lackierter Sportwagen" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-70 group-hover:opacity-100" />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-90 flex items-end p-8">
                <div>
            ...
            <div className="relative group overflow-hidden h-[300px] md:h-full cursor-pointer border-r border-gray-900">
            <img src="https://images.unsplash.com/photo-1562259949-e8e7689d7828?q=80&w=2000&auto=format&fit=crop" alt="Farbmischbank Lackdosen" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-70 group-hover:opacity-100" />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-90 flex items-end p-8">
                <div>
            ...
            <img src="https://images.unsplash.com/photo-1575024357670-2b5164f470c3?q=80&w=2000&auto=format&fit=crop" alt="Lackierpistole Nahaufnahme" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110 opacity-70 group-hover:opacity-100" />
            <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent opacity-90 flex items-end p-8">
                <div>
      ...
      <div className="bg-gray-surface py-24 border-t border-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            ...
            <article className="prose prose-invert prose-lg max-w-none text-gray-300 font-light">
              <p className="lead text-2xl text-white font-normal mb-10 border-l-4 border-gray-700 pl-6 py-2">
              ...
              <div className="mb-16 bg-deep-black p-8 rounded-2xl border border-gray-800">
                 ...
                 <img 
                    ...
                    className="w-full h-64 object-cover rounded-lg border border-gray-700 my-8 shadow-2xl brightness-90 hover:brightness-100 transition-all"
                 />

                 <div className="bg-gray-highlight p-6 rounded-lg border border-gray-700 my-8 flex gap-4 items-start shadow-inner">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 items-center">
                 <div className="order-2 md:order-1">
                    ...
                    <div className="relative group">
                        <div className="absolute -inset-1 bg-gradient-to-r from-accent-primary to-gray-800 rounded-lg blur opacity-25 group-hover:opacity-50 transition duration-1000 group-hover:duration-200"></div>
                        <img 
                        ...
                        className="relative w-full rounded-lg shadow-2xl mb-4 border border-gray-800"
                        />
                    </div>
       ...
       <div className="bg-deep-black py-20 border-t border-gray-800">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 px-4 max-w-7xl mx-auto">
                <div className="grid gap-4">
                    <img className="h-auto max-w-full rounded-lg object-cover hover:opacity-90 transition-opacity border border-gray-800" src="https://images.unsplash.com/photo-1615900119312-2acd3a71f3aa?q=80&w=800&auto=format&fit=crop" alt="Spritzpistole Action" />
                    <img className="h-auto max-w-full rounded-lg object-cover hover:opacity-90 transition-opacity border border-gray-800" src="https://images.unsplash.com/photo-1552519507-da3b142c6e3d?q=80&w=800&auto=format&fit=crop" alt="Roter Lack Sportwagen" />
                </div>
                <div className="grid gap-4">
                    <img className="h-auto max-w-full rounded-lg object-cover hover:opacity-90 transition-opacity border border-gray-800" src="https://images.unsplash.com/photo-1562259926-4b31a297e68c?q=80&w=800&auto=format&fit=crop" alt="Lackdosen Regal" />
                    <img className="h-auto max-w-full rounded-lg object-cover hover:opacity-90 transition-opacity border border-gray-800" src="https://images.unsplash.com/photo-1625047509168-a7026f36de04?q=80&w=800&auto=format&fit=crop" alt="Maler in Kabine" />
                    <img className="h-auto max-w-full rounded-lg object-cover hover:opacity-90 transition-opacity border border-gray-800" src="https://images.unsplash.com/photo-1600661653561-629509216228?q=80&w=800&auto=format&fit=crop" alt="Schleifen Handarbeit" />
                </div>
                <div className="grid gap-4">
                    <img className="h-auto max-w-full rounded-lg object-cover hover:opacity-90 transition-opacity border border-gray-800" src="https://images.unsplash.com/photo-1613214149922-f1809c99e35f?q=80&w=800&auto=format&fit=crop" alt="Detailing Finish" />
                    <img className="h-auto max-w-full rounded-lg object-cover hover:opacity-90 transition-opacity border border-gray-800" src="https://images.unsplash.com/photo-1575024357670-2b5164f470c3?q=80&w=800&auto=format&fit=crop" alt="Lackierpistole Nahaufnahme" />
                </div>
            </div>
       </div>
      ...
      <div className="bg-gray-surface py-24 border-t border-gray-800">
        <div className="max-w-3xl mx-auto px-4">
             ...
             <div className="space-y-4">
                <div className="group border border-gray-700 hover:border-accent-primary p-8 rounded-lg bg-deep-black transition-all duration-300">
