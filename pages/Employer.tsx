...
export const Employer = () => {
  ...
  return (
    <div className="min-h-screen bg-black font-sans text-gray-200">
        ...
        <div className="relative border-b border-gray-800 py-24 px-4 text-center overflow-hidden">
             <div className="absolute inset-0 z-0">
                <img src="https://images.unsplash.com/photo-1599813009696-857c50e28f32?q=80&w=2000&auto=format&fit=crop" className="w-full h-full object-cover opacity-30" alt="Werkstatt Background" />
                <div className="absolute inset-0 bg-gradient-to-t from-black via-black/80 to-transparent"></div>
             </div>
             
             <div className="relative z-10">
                <h1 className="text-3xl md:text-5xl font-display font-black text-white uppercase mb-4">
      ...
      <div className="max-w-6xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-4">
                <div className="bg-gray-900 rounded-xl border border-gray-800 p-8 sticky top-32 shadow-xl">
                    <div className="flex items-center mb-8">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-white uppercase leading-none">Smart Recruiting</h2>
                    ...
                    <div className="space-y-6 mb-8">
                        <div className="flex">
                            <div className="mr-4 mt-1 bg-gray-800 p-1 rounded-full h-fit">
                                <Check size={12} className="text-white" />
                            </div>
                            <div>
                                <h4 className="font-bold text-white text-sm">Automatische Texte</h4>
                        ...
                        <div className="flex">
                            ...
                            <div>
                                <h4 className="font-bold text-white text-sm">Zielgenaue Reichweite</h4>
                    ...
                    <div className="pt-8 border-t border-gray-800">
                        <div className="flex items-end justify-between mb-2">
                             <span className="text-gray-400 text-sm">Einzelanzeige</span>
                             <span className="text-2xl font-black text-white">49 €</span>
                        </div>
                        <p className="text-xs text-gray-600 text-right mb-6">zzgl. gesetzl. MwSt. / 30 Tage Laufzeit</p>
                        <button className="w-full py-3 bg-gray-800 text-gray-300 font-bold text-sm uppercase rounded hover:bg-gray-700 transition-colors">
                    ...
                    {step === 1 && (
                        <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                            <div className="flex justify-between items-center mb-10">
                                <h3 className="text-2xl font-bold font-display uppercase tracking-tight">Anzeige erstellen</h3>
                            ...
                            <div className="space-y-8">
                                <div>
                                    ...
                                    <input 
                                        type="text" 
                                        className="w-full bg-gray-50 border border-gray-200 rounded-lg p-4 text-black font-medium focus:border-accent-primary focus:ring-2 focus:ring-accent-primary/10 outline-none transition-all"
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        className="w-full min-h-[150px] bg-gray-50 border border-gray-200 rounded-lg p-4 text-black font-medium focus:border-accent-primary focus:ring-2 focus:ring-accent-primary/10 outline-none transition-all resize-none"
                            ...
                            <div className="mt-12 flex justify-end">
                                <button 
                                    ...
                                    className="bg-black text-white font-bold font-display uppercase tracking-widest py-4 px-8 rounded-lg hover:bg-gray-800 transition-all flex items-center gap-3 disabled:opacity-70 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
                                >
                                    {isGenerating ? (
                                        <>
                    ...
                    {step === 2 && generatedContent && (
                        <div className="animate-in fade-in slide-in-from-right-8 duration-500">
                            <div className="flex justify-between items-center mb-8 pb-6 border-b border-gray-100">
                                <h3 className="text-2xl font-bold font-display uppercase tracking-tight">Vorschau & Abschluss</h3>
                                <button onClick={() => setStep(1)} className="text-xs font-bold text-gray-400 hover:text-black uppercase tracking-widest flex items-center transition-colors">
                            ...
                            <div className="bg-gray-50 rounded-xl p-8 border border-gray-200 mb-10 relative overflow-hidden">
                                ...
                                <h4 className="text-2xl font-display font-black text-black mb-6 uppercase">{generatedContent.title}</h4>
                                <p className="text-gray-700 mb-8 leading-relaxed font-sans">{generatedContent.description}</p>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div>
                                        <h5 className="font-bold text-black uppercase mb-4 text-xs tracking-widest border-b-2 border-accent-primary w-fit pb-1">Ihr Profil</h5>
                                    ...
                                    <div>
                                        <h5 className="font-bold text-black uppercase mb-4 text-xs tracking-widest border-b-2 border-accent-primary w-fit pb-1">Wir bieten</h5>
                                        <ul className="space-y-3">
                            ...
                            <div className="bg-blue-50 border border-blue-100 rounded-lg p-6 mb-8">
                                ...
                                <input 
                                    type="email" 
                                    required
                                    className="w-full bg-white border border-blue-200 rounded p-4 text-black focus:border-blue-500 outline-none transition-colors"
                            ...
                            <button 
                                ...
                                className="w-full bg-accent-primary text-white font-bold font-display uppercase tracking-widest py-5 rounded-lg hover:bg-red-600 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-3"
                            >
                                <Save size={20} /> 
